...
export const velidateFormRegister = (form: valuesTypesRegisterPrueba) => {
  ...
  if (!form.password) {
    ...
    errors.password = 'La contraseña debe cumplir con los requisitos: al menos 5 caracteres, una letra mayúscula, una minúscula, un número y un carácter especial.'
  }
  ...
  if (!form.phone) {
    ...
    errors.phone = 'El número de teléfono debe tener entre 5 y 15 dígitos, y puede incluir un signo de más'
  }
