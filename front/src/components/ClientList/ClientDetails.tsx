...
const ClientDetails: React.FC = () => {
  ...
  return (
    <div className="shadow-md rounded-lg overflow-hidden mt-4">
      <h2 className="text-[2.5rem] font-semibold px-6 py-4">Detalles del Cliente</h2>
      <div className="px-6 py-4">
        <h3><strong>Nombre:</strong> {client.name}</h3>
        <h3><strong>Email:</strong> {client.email}</h3>
        <h3><strong>Teléfono:</strong> {client.phone}</h3>
      </div>
