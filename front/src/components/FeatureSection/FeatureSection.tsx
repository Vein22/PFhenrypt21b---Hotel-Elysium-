      ...
      <div className="container mx-auto grid md:grid-cols-2 gap-8 items-center">
        ...
        <div>
          ...
          <ul className="flex space-x-1"> 
            <li><span className="font-bold text-amber-600 text-[3rem]">250+</span> Habitaciones de Lujo</li>
            <li><span className="font-bold text-amber-600 text-[3rem] ml-5">4.9</span> Calificación de los Clientes</li>
          </ul>
