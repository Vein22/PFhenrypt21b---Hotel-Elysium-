...
const Footer = () => {
  return (
    <footer className="bg-grisOscuro py-6 px-4 md:px-8 lg:px-16">
      <div className="container mx-auto text-center">
        <div className="flex flex-col md:flex-row justify-between border-b border-mostaza py-6 gap-4">
          <div className="flex items-center gap-2">
            <Image
              src="/saul/location.svg"
              alt="Dirección"
          ...
          <div className="flex items-center gap-2">
            <Image src="/saul/mail.svg" alt="Email" width={30} height={30} />
            <div className="flex flex-col items-start">
              <h3 className="text-white uppercase">Consultas y reservas</h3>
              <span className="font-secondary text-grisClaro">
                proyectohenrypt21b@gmail.com
