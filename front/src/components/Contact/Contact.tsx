...
const ContactForm = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8">
      <div className="bg-beige p-6 md:p-12 rounded-lg shadow-lg w-full max-w-6xl flex flex-col lg:flex-row gap-12">
        <div className="flex-1">
          <span className="font-primary text-mostaza uppercase block text-lg">
            Elysium
          </span>
          <h6 className="font-primary text-4xl text-grisOscuro leading-tight mt-2">
            CONTÁCTENOS
          </h6>
          <p className="text-grisOscuro text-base mt-4">
        ...
        <div className="flex-1 w-full bg-grisOscuro text-white p-6 md:p-10 rounded-lg shadow-lg">
          <h2 className="text-3xl sm:text-4xl font-primary">CONSÚLTANOS</h2>
          ...
          <form className="my-6 space-y-6" onSubmit={handleSubmit}>
            <div>
              <input
                ...
                className={`w-full p-3 bg-white text-black placeholder-gray-400 rounded-md focus:ring-2 focus:outline-none ${
            ...
            <button
              ...
              className={`w-full p-3 rounded-md transition duration-300 ${
                !isFormValid()
                  ...
                  : "bg-mostaza hover:bg-opacity-80"
              }`}
            >
